        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <p class="text-gray-300 mt-8">
                    ...
                    Culpa aperiam consectetur optio animi delectus officia,
                    tempora, consequatur inventore iste, eum at voluptate
                    perferendis! Quod magni, fuga, atque placeat totam,
                    nam quibusdam esse cumque at nobis similique laudantium!
                    Illo velit distinctio tempora deleniti totam, adipisci
                    voluptatibus, similique soluta doloremque nobis aliquam?
                </p>
                <div class="mt-12">
                ...
                <div class="mt-12">
                    <button class="flex items-center bg-red-500 text-gray-900 rounded font-semibold px-5
