...
@section('content')
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src={{ $showDetails['poster_path'] }} alt="backdrop" class="w-64 lg:w-96">
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold">{{ $showDetails['name'] }}</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span class="ml-1">{{ $showDetails['vote_average'] }}</span>
                ...
                <div x-data="{ isOpen: false }">
                    @if(count($showDetails['videos']['results']) > 0)
                        <div class="mt-12">
                            ...
                            <div class="bg-gray-900 rounded">
                                ...
                                <div class="modal-body px-8 py-8">
                                    <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                        <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/{{ $showDetails['videos']['results'][0]['key'] }}" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="tv-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                @foreach ($showDetails['cast'] as $castMember)
                    <div class="mt-8">
    ...
    <div class="tv-images border-b border-gray-800" x-data="{ isOpen: false, image: '' }">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                @foreach ($showDetails['images'] as $image)
                    <div class="mt-8">
