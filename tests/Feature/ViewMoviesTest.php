        ...
        return Http::response([
            'results' => [
                [
                    ...
                    "id" => 419704,
                    "adult" => false,
                    "backdrop_path" => "/5BwqwxMEjeFtdknRV7925voBk1v.jpg",
                    ...
                    "title" => "Fake Movie",
                    "vote_average" => 6,
                    "overview" => "Fake Movie description. The near future, a time when both hope and
                        hardships drive humanity to look to the stars and beyond. While a mysterious
        ...
        return Http::response([
            'results' => [
                [
                    ...
                    "vote_count" => 2607,
                    "video" => false,
                    "poster_path" => "/xBMvZcjRiWyobQ9kx8hO6B2dtRI.jpg",
                    "id" => 419704,
                    "adult" => false,
                    "backdrop_path" => "/50wqwxMEjeFtdknRV7925vo0K1v.jpg",
                    "original_language" => "en",
                    ...
                    "vote_average" => 6,
                    "overview" => "Now playing fake movie description. The near future, a time when both hope and
                    hardships drive humanity to look to the stars and beyond. While a mysterious
                    phenomenon menaces to destroy life on planet earth.",
                    "release_date" => "2019-09-17",
                ]
